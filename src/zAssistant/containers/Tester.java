...
public class Tester<C> {
    ...
    public void setHeadline(String newHeadline) { headline = newHeadline; }
    ...
    public void displayHeader() {
        ...
        Print.print(head);
        Print.format(sizeField, "size");
        for (Test test : tests) {
            Print.format(stringField(), test.name);
        }
        Print.print();
    }
    public void timedTest() {
        ...
        for (TestParam param : paramList) {
            Print.format(sizeField, param.size);
            for (Test<C> test : tests) {
                ...
                Print.format(numberField(), timePerRep);
            }
            Print.print();
        }
    }
