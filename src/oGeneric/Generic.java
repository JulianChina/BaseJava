...
import zAssistant.generics.Mixins;
import zUtils.*;
            ...
            public static class DynamicProxyMixin {
                public static void main(String[] args) {
                    Object mixin = MixinProxy.newInstance(
                            Tuple.tuple(new Mixins.BasicImp(), zAssistant.generics.Mixins.Basic.class),
                            Tuple.tuple(new Mixins.TimeStampedImp(), zAssistant.generics.Mixins.TimeStamped.class),
                            Tuple.tuple(new Mixins.SerialNumberedImp(), zAssistant.generics.Mixins.SerialNumbered.class)
                    );
                    zAssistant.generics.Mixins.Basic b = (zAssistant.generics.Mixins.Basic) mixin;
                    zAssistant.generics.Mixins.TimeStamped t = (zAssistant.generics.Mixins.TimeStamped) mixin;
                    zAssistant.generics.Mixins.SerialNumbered s = (zAssistant.generics.Mixins.SerialNumbered) mixin;
                    b.set("Hello");
                    Print.print(b.get());
