        ...
        //String.format()
            public static class Hex {
                ...
                public static void main(String[] args) {
                    try {
                        if (args.length==0) {
//                            System.out.println(format(inputStream2ByteArray("/Users/julian/cyl/BaseJavaKotlin/out/production/BaseJava/mString/MString$Hex.class")));
                            System.out.println(format(BinaryFile.read("/Users/julian/cyl/BaseJavaKotlin/out/production/BaseJava/mString/MString$Hex.class")));
                        } else {
    ...
    //13.6 正则表达式
        ...
        //替换操作
            ...
            public static class TheReplacements {
                public static void main(String[] args) {
                    String s = TextFile.read("/Users/julian/cyl/BaseJavaKotlin/BaseJava/src/mString/MString.java");
