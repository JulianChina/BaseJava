package ThinkingInJava.nTypeInformation;

import ThinkingInJava.zAssistant.typeinfo.Factory;
...
public class TypeInformation {
    ...
    //14.2 Class对象
        ...
        public static class ToyTest {
            ...
            public static void main(String[] args) {
                Class c = null;
                try {
                    c = Class.forName("ThinkingInJava.nTypeInformation.TypeInformation$FancyToy");
    ...
    //14.4 注册工厂
        ...
        static class FuelFilter extends Filter {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<FuelFilter> {
                public FuelFilter create() { return new FuelFilter(); }
            }
        }
        static class AirFilter extends Filter {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<AirFilter> {
                public AirFilter create() { return new AirFilter(); }
            }
        }
        static class CarbinAirFilter extends Filter {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<CarbinAirFilter> {
                public CarbinAirFilter create() { return new CarbinAirFilter(); }
            }
        }
        static class OilFilter extends Filter {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<OilFilter> {
                public OilFilter create() { return new OilFilter(); }
            }
        }
        static class Belt extends Part { }
        static class FanBelt extends Belt {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<FanBelt> {
                public FanBelt create() { return new FanBelt(); }
            }
        }
        static class GeneratorBelt extends Belt {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<GeneratorBelt> {
                public GeneratorBelt create() { return new GeneratorBelt(); }
            }
        }
        static class PowerSteeringBelt extends Belt {
            public static class Factory implements ThinkingInJava.zAssistant.typeinfo.Factory<PowerSteeringBelt> {
