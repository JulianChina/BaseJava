...
import ThinkingInJava.zAssistant.annotations.database.Constraints;
import ThinkingInJava.zAssistant.annotations.database.DBTable;
import ThinkingInJava.zAssistant.annotations.database.SQLInteger;
import ThinkingInJava.zAssistant.annotations.database.SQLString;
...
import static ThinkingInJava.zUtils.Print.print;
...
public class TableCreationProcessorFactory implements AnnotationProcessorFactory {
    ...
    public Collection<String> supportedAnnotationTypes() {
        return Arrays.asList("ThinkingInJava.zAssistant.annotations.database.DBTable",
                "ThinkingInJava.zAssistant.annotations.database.Constraints",
                "ThinkingInJava.zAssistant.annotations.database.SQLString",
                "ThinkingInJava.zAssistant.annotations.database.SQLInteger");
    }
