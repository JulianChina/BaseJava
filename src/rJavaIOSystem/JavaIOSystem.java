...
public class JavaIOSystem {
    ...
    //18.6 I/O流的典型使用方式
        static final String fileName = "/Users/julian/cyl/BaseJavaKotlin/BaseJava/src/rJavaIOSystem/JavaIOSystem.java";
        //缓冲输入文件
    ...
    //18.9 进程控制
        ...
        public static class OSExecuteDemo {
            public static void main(String[] args) {
                OSExecute.command("javap out/production/BaseJava/rJavaIOSystem/JavaIOSystem$OSExecuteDemo");
            }
        }
